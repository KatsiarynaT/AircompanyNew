...
namespace Aircompany
{
    public class Airport
    {
        ...
        public Airport SortByMaxDistance() => new Airport(Planes.OrderBy(w => w.GetMaxFlightDistance()));

        public Airport SortByMaxSpeed() => new Airport(Planes.OrderBy(w => w.GetMaxSpeed()));

        public Airport SortByMaxLoadCapacity() => new Airport(Planes.OrderBy(w => w.GetMaxLoadCapacity()));
