...
namespace AircompanyTests.Tests
{
    ...
    public class AirportTest
    {
        ...
        public void TestGetTransportMilitaryPlanes()
        {
            ...
            Assert.IsTrue(transportMilitaryPlanes.All(militaryPlane => militaryPlane.Type == MilitaryType.TRANSPORT));
        }
        ...
        {
            Airport airport = new Airport(planes);
            List<Plane> planesSortedByMaxLoadCapacity = new List<Plane>()
            {
                new MilitaryPlane("F-15", 1500, 12000, 10000, MilitaryType.FIGHTER),
                new MilitaryPlane("F-22", 1550, 13000, 11000, MilitaryType.FIGHTER),
                new PassengerPlane("Embraer 190", 870, 8100, 30800, 64),
            ...
            Assert.AreEqual(airport.SortByMaxLoadCapacity().GetPlanes(), planesSortedByMaxLoadCapacity);
        }
    }
}
